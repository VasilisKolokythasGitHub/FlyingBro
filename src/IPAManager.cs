...
using UnityEngine.Purchasing;
	...
	public class IPAManager : MonoBehaviour, IStoreListener
	{

	public static IPAManager Instance{ set; get;}
		private static IStoreController m_StoreController;          
		private static IExtensionProvider m_StoreExtensionProvider;   
 
		public static string Product_Thug_Life =    "thug_life_glasses";   
		public static string Product_Xmas_Hat = "xmashat";
	...
	private void Awake()
	{
		...
		builder.AddProduct(Product_Thug_Life, ProductType.NonConsumable);
			// Continue adding the non-consumable product.
		builder.AddProduct(Product_Xmas_Hat, ProductType.NonConsumable);

		builder.AddProduct(Product_energy, ProductType.Consumable);
		...
		public void Buy_Thug_Life_Glasses()
		{
			// Buy the consumable product using its general identifier. Expect a response either 
			// through ProcessPurchase or OnPurchaseFailed asynchronously.
		BuyProductID(Product_Thug_Life);
		}


		public void Buy_Xmas_Hat()
		{
			// Buy the consumable product using its general identifier. Expect a response either 
			// through ProcessPurchase or OnPurchaseFailed asynchronously.
			BuyProductID(Product_Xmas_Hat);
		}

	public void Buy_Energy()
	{
		// Buy the consumable product using its general identifier. Expect a response either 
		// through ProcessPurchase or OnPurchaseFailed asynchronously.
		BuyProductID(Product_energy);
	}
